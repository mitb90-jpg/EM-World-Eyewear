...
VISA_DEBIT_RULES = {
    ...
    "BARTONPERREIRA|CARLZEISSVISION|DITA|KERING|LUXOTTICAOFCANADATORONTOON|MARCOLINCANADA|ORGREENGOLDSMITH|SAFILO|SALTOPTICS|THELIOS|SQ*SWEATANDTONICTORONTOON": "Purchases",
    "AXISMEDICAL": "Repairs and Maintenance",
    "UBER|AIRCAN": "Travel Expense",
...
if page == "📊 Reports":
    ...
    with visa_col1:
        uploaded_visa_pdf = st.file_uploader(
            "Upload Visa-6023 Statements PDF(s)",
            type=["pdf"],
            accept_multiple_files=True,
