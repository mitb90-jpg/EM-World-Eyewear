...
VISA_DEBIT_RULES = {
    ...
    "ELEGANCE DRY CLEANERS|HM HENNES|IHUC|LCBO|MEC MOUNTAIN EQUIPMENT|THE BEER STORE|NETFLIX|Air Can|BANANA REPUBLIC|MDHAIR|": "Personal Expense",
...
VISA_CREDIT_RULES = {
    "SCOTIABANK PAYMENT|PMT|Telepayments|Costco Wholesale|Fresgco": "Credit Card Payments",
